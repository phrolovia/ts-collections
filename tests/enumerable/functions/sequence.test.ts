...
describe("#sequence()", () => {
    ...
    it("should include end with negative step", () => {
    ...
    it("should throw error if start is NaN", () => {
        expect(() => sequence(Number.NaN, 11, 2)).toThrow(InvalidArgumentException);
    });
    it("should throw error if end is NaN", () => {
        expect(() => sequence(1, Number.NaN, 1)).toThrow(InvalidArgumentException);
    });
    it("should throw error if step is NaN", () => {
        expect(() => sequence(1, 11, Number.NaN)).toThrow(InvalidArgumentException);
    });
    it("should throw error if step is greater than 0 and end is smaller than start", () => {
        expect(() => sequence(10, 2, 1)).toThrow(InvalidArgumentException);
    });
    it("should throw error if step is less than 0 and end is greater than start", () => {
        expect(() => sequence(1, 10, -1)).toThrow(InvalidArgumentException);
    });
    it("should throw error if step is 0 and end is not equal to start", () => {
        expect(() => sequence(1, 10, 0)).toThrow(InvalidArgumentException);
    });
    it("should return start if start is equal to end and step is 0", () => {
